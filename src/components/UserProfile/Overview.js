        ...
        <div className="over-card">
            <div className="over-header">
                ...
                <div>
                    ...
                    <span>by  <p className="over-subtitle"> {subtitle}</p></span>
                </div>
            </div>
            ...
            <div className="over-tags">
                <span className="over-tag" style={{ backgroundColor: "#5ad60d19", color: "#5ad60d" }}>Trend</span>
                <span className="over-tag" style={{ backgroundColor: "#2da6ae19", color: "#2da6ae" }}>Mid Term</span>
                <span className="over-tag" style={{ backgroundColor: "#399cf719", color: "#399cf7" }}>Algo</span>
                <span className="over-tag" style={{ backgroundColor: "#deae3e19", color: "#deae3e" }}>Long & Short</span>
                <span className="over-tag" style={{ backgroundColor: "#ff964219", color: "#ff9642" }}>Medium Risk</span>
            </div>
...
const Overview = () => {
    const data = [10, 15, 20, 25, 40, 42, 41, 44, 43, 48, 40, 42, 41, 44, 43, 48, 50, 52, 50, 55, 58, 60, 62, 65, 68, 50, 52, 50, 55, 58, 60, 62, 65, 68, 40, 42, 41, 44, 43, 48, 50, 52, 50, 55, 58, 60, 62, 65, 68, 40, 40, 42, 41, 44, 43, 48, 50, 52, 50, 55, 58, 60, 62, 65, 68, 42, 41, 44, 43, 48, 50, 52, 50, 55, 58, 60, 62, 65, 68, 22, 30, 35, 32, 38, 37, 40, 42, 41, 44, 43, 48, 50, 52, 50, 55, 58, 60, 62, 65, 68];
