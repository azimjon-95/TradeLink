...
import { shareModalText } from "./lang";
...
function ShareModal({ closeModal }) {
  ...
  const shareMessage = shareModalText[lang].shareMessage;
  ...
  return (
    <div className="user-modal-overlay" onClick={closeModal}>
      <div className="user-modal-content" onClick={(e) => e.stopPropagation()}>
        <h2>{shareModalText[lang].caption}</h2>
        <button className="user-close-modal-btn" onClick={closeModal}>
          ✖
        </button>
        ...
        <div className="user-modal-daw-img" ref={imageRef}>
          ...
          <span>
            {/* Best-selected <br /> trading strategies <br /> from around the world */}
            {/* {shareModalText[lang].text} */}
        ...
        <div className="user-modal-icons">
          ...
          <div className="link-btns">
            <button onClick={openTelegramShare}>
          ...
          <div className="link-btns">
            ...
            <span>{shareModalText[lang].copyBtn}</span>
          </div>
        </div>
      </div>
    </div>
