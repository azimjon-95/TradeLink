...
const translations = {
  ...
  ru: {
    ...
    portfolioSteps: [
      "Чтобы добавить ваш портфель в рейтинг и соревноваться с другими рейтингaми, выполните простые шаги:",
    ...
    kytTitle: "Рейтинг KYT-рейтинг",
    kytPurpose:
      "Цель рейтинга KYT-рейтинг — выявить стратегии с лучшим соотношением риска и доходности, а также учитывать ряд косвенных факторов, таких как срок действия стратегии, средний депозит и прибыльность за разные периоды времени.",
    kytDetails:
      "Чем выше балл KYT-рейтинг, тем более сбалансирована стратегия с точки зрения риска, прибыли и истории торговли.",
    formulaTitle: "Общая формула:",
    indicatorsTitle:
      "Следующие показатели используются для расчета балла KYT-рейтинг:",
    growthRate:
