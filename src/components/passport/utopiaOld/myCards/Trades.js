        ...
        items: [
          {
            label: "Limit orders",
            value: `${
              data?.trades_stats?.orders_by_types?.limit_orders.toLocaleString() ||
              0
            }`,
            originalValue:
          ...
          },
          {
            label: "Market orders",
            value: `${
              data?.trades_stats?.orders_by_types?.market_orders.toLocaleString() ||
              0
            }`,
            originalValue:
          ...
          },
          {
            label: "Total trades",
            value: `${
              data?.trades_stats?.orders_by_types?.total_trades.toLocaleString() ||
              0
            }`,
            originalValue:
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            label: "Ratio",
            value: `${
              data?.trades_stats?.orders_by_side?.ratio.toFixed(2) || 0
            }`,
        ...
        items: [
          {
            label: "Maximum",
            value: `${
              data?.trades_stats?.orders_size_info?.maximum.toLocaleString() ||
              0
            }`,
          ...
          },
          {
            label: "Average",
            value: `${
              data?.trades_stats?.orders_size_info?.average.toFixed(2) || 0
            }`,
          ...
          },
          {
            label: "Minimum",
            value: `${
              data?.trades_stats?.orders_size_info?.minimum.toFixed(2) || 0
            }`,
