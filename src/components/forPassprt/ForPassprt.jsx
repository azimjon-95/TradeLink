...
function ForPassprt() {
  ...
  return (
    <div className="forPaspport">
      <div className="forPaspport_media">
        {isModalSinUp && (
          <SignUpModal
            ...
            <div className="ps_btns">
              {buttons.map((button) => (
                <button
                  key={button.id}
                  className={
                    activeCard === button.id ? "ps_btns_active" : "ps_btns_none"
                  }
              ...
              <div className="forTrader_bottom_step-icon">
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor="#35009E" />
                      <stop offset="0.519" stopColor="#8F41D3" />
                      <stop offset="1" stopColor="#CD11EE" />
                    </linearGradient>
                    <linearGradient
