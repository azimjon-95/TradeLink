...
const Banner = () => {
    ...
    const reviews = [
        { name: 'Bogdan Miroshnichenko', store: 3, text: 'very good balance-profit tracker. cozy chat, support. developing copytrading marketplace.', date: 'Jun 10, 2024', image: '' },
        { name: 'Zhas Ak', store: 5, text: 'In total I have been working with project KYT - Know Your Trader passport for about two years. During this time, I was pleased with the convenience of displaying trading statistics, clear monitoring of the current portfolio situation, and correct dynamics graphs. The opportunity to participate in ratings provides motivation and an incentive for growth. All this data improves trading and makes it more profitable. Special thanks to the support team who are always in touch and eliminate any controversial issues. I recommend this product to all active traders and crypto investors.', date: 'Jun 12, 2024', image: '' },
        { name: 'Anna Petrov', store: 3.5, text: "An excellent service for monitoring your trading results. I've been using it for a long time and enjoy it. All good", date: 'Jun 14, 2024', image: '' },
        { name: 'Ivan Ivanov', store: 4, text: 'Great resource for trading account monitoring. Works perfectly. My exp. more than 2 years, totally recomended!', date: 'Jun 15, 2024', image: '' },
        { name: 'Sara Lee', store: 2, text: 'Good service with detailed trading account statistics. Shows not only PnL history, but also 50+ other parameters. Very convenient and clear for demonstrating to investors.', date: 'Jun 16, 2024', image: '' },
        { name: 'Liam Johnson', store: 2.7, text: "Among the many scammers in the market, this is one of the best ways to prove your competence and transparency for free. I really liked the service’s approach to statistics. This is much more than a regular trader's diary!", date: 'Jun 17, 2024', image: '' },
        { name: 'Sophia Kim', store: 5, text: "I’ve been using this platform to build my reputation as a trader, and it’s been incredibly effective. The verification of my trading history and the detailed performance stats help showcase my skills to potential investors and followers. It’s a great way to gain visibility and credibility in the trading community.", date: 'Jun 18, 2024', image: '' },
        { name: 'James Chen', store: 3.5, text: "With the copy trading feature, I can maximize my earnings without putting in the work of an active trader. I pick top traders to copy and let the platform handle the rest. It’s been an easy and efficient way to grow my portfolio and generate passive income. Can’t forget to add that I can always manage my assets myself, so that I don't need to worry about my money like if I manage my assets directly to a trader. Overall copy trading on this platform is fantastic and clear, highly recommend", date: 'Jun 19, 2024', image: '' },
    ];
            ...
            <div className="review-card" onClick={() => onClick(review)}>
                <div className="img-stor">
                    <div className="avatar-mod-image">
                        {review.image ? (
                            <img src={review.image} alt={`${review.name}'s avatar`} className="review-avatar" />
                        ) : (
        ...
        return (
            <div className="modal-overlay-review" onClick={onClose}>
                <div className="modal-content-review" onClick={(e) => e.stopPropagation()}>
                    <button className="close-button-review" onClick={onClose}>X</button>
                    <img src={review.image} alt={review.name} className="review-avatar-large" />
                    <h4 className="review-name">{review.name}</h4>
    ...
    const blogPosts = [
        {
            ...
            description: 'Crypto trading is becoming an increasingly popular form of investment activity, attracting both professional traders and beginners...',
        ...
        },
        {
            ...
            description: 'Copy trading is an investment strategy that allows inexperienced traders to execute trades made by more experienced and successful market specialists...',
        ...
        },
        {
            ...
            description: 'We have great news: we have launched a new version of Jet 2.0...',
        ...
        <>
            <div className="homePage">
                <header className="homePage__header">
                    <h1 className="homePage__title">Independent Assessment Standard of traders <br /> and investments in the world's best strategies</h1>
                    <p className="homePage__subtitle">
                        We help traders to verify trading statistics and attract investments, and we provide investors
                        with proven low-risk trading strategies
                    </p>
                    <button className="homePage__signUpButton">Sign up</button>
                </header>
            ...
            <div className="marketplace">
                <div className="marketplace-passporte">
                    ...
                    <div className="marketplace-container">
                        <p className="marketplace-subtitle_pass ">International standard of trader assessment</p>
                        <h1 className="marketplace-title">
                            <span role="img" aria-label="logo">📊</span> KYT - Know Your Trader Passport
                        </h1>
                        <p className="marketplace-description">
                            Objective and independent assessment of traders’ skills and performance.
                        </p>
                        ...
                        <ul className="marketplace-benefits">
                            ...
                            <li>
                                ...
                                All tools available in one place starting from statistics to investment attraction
                            </li>
                        </ul>
            ...
            <div className="mission-container">
                <div className="mission-content">
                    <h4>Our mission</h4>
                    <h2>We make the crypto trading market fair <br /> and transparent</h2>
                </div>
            </div>
            ...
            <div className="app-container">
                <div className="section marketplace-section">
                    <div className="marketplace-header">
                        ...
                        <span>
                            <h2 className="marketplace-title">Submit your strategy on the <br />KYT - Know Your Trader  Marketplace <br />and get new clients</h2>
                            <p className="marketplace-subtitle">We take care of all other work with the investor.</p>
                        </span>
                ...
                <div className="marketplace-section-box">
                    <div className="section widget-section">
                        <div className="statistics">
                            <h2 className="widget-title">Place KYT - Know Your Trader<br /> widget on your website</h2>
                            <p className="widget-subtitle">Share your strategy results on  your<br /> personal website using widget.</p>
                        </div>
                    ...
                    <div className="section referral-section">
                        <h2 className="referral-title">KYT - Know Your Trader Marketplace Referral Program</h2>
                        <p className="referral-subtitle">Earn a commission on your invited friends' profits without hidden platform fees.</p>
                            ...
                            <div className="blog-section__card-content">
                                <div className="blog-section__card-bottom">
                                    ...
                                    <div className="blog-section__card-tags">
                                        {post.tags.map((tag, i) => (
                                            <span key={i} className="blog-section__card-tag">#{tag}</span>
                                        ))}
                                    </div>
                                </div>
                                <h3 className="blog-section__card-title">{post.title}</h3>
                                <p className="blog-section__card-description">{post.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
